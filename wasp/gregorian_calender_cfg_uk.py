...
TRANSLATE_DAY = {
    ...
    "Birthday of Martin Luther King, Jr" : {"name" : "Birthday of Martin Luther King, Jr", "type":SpecialDayType.INFO_DAY } , 
    "Washington's Birthday"              : {"name" : "Washington's Birthday"             , "type":SpecialDayType.INFO_DAY } , 
    "Memorial Day (us)"                  : {"name" : "Memorial Day (us)"                 , "type":SpecialDayType.INFO_DAY } , 
    "US Independence Day"                : {"name" : "US Independence Day"               , "type":SpecialDayType.INFO_DAY } , 
    "Labor Day (us)"                     : {"name" : "Labor Day (us)"                    , "type":SpecialDayType.INFO_DAY } , 
    "Columbus Day"                       : {"name" : "Columbus Day"                      , "type":SpecialDayType.INFO_DAY } , 
    "Veterans Day (us)"                  : {"name" : "Veterans Day (us)"                 , "type":SpecialDayType.INFO_DAY } , 
    "Thanksgiving (us)"                  : {"name" : "Thanksgiving (us)"                 , "type":SpecialDayType.INFO_DAY } , 
    "US Independence Day observed"       : {"name" : "US Independence Day observed"      , "type":SpecialDayType.INFO_DAY } , 
    "Veterans Day (us) observed"         : {"name" : "Veterans Day (us) observed"        , "type":SpecialDayType.INFO_DAY } , 
    "Juneteenth (us)"                    : {"name" : "Juneteenth (us)"                   , "type":SpecialDayType.INFO_DAY } , 
} 
